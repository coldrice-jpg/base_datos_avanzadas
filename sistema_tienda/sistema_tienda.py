...
# 3. SCRIPT AUTOMATIZADO DE PRUEBAS
...
def ejecutar_pruebas():
    ...
    # Apertura 1 de la base de datos
    gestor = GestorBDOO()
    ...
    # Prueba 5 y 6: Registrar venta y Actualizar inventario
    ...
    # Prueba 7: Consulta relacionada (Reporte diario)
    print(
    ...
    # Prueba 8: Cerrar y abrir el sistema (Persistencia real en disco)
